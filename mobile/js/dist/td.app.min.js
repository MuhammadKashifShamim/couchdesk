            ...
            $ionicActionSheet.show({
              ...
              buttonClicked: function (index) {
                switch (index) {
                  ...
                  case 1:
                    reqTicket = { _id: $scope.ticket._id, status: 4 }
                    return (
                      Tickets.update(reqTicket).then(
                        function (response) {
                          ;($scope.ticket.status = 4), $scope.showSnackbar('Ticket status set to Working')
                        },
                        function (response) {
                          console.log(response)
                        }
    ...
    .controller('TicketsCtrl', function (
      ...
      $ionicNavBarDelegate.showBackButton(!0),
        ...
        ($scope.showActionSheet = function ($event, $ticket) {
          ...
          $scope.isAgent &&
            (buttons.push({ text: 'Open' }), buttons.push({ text: 'Working' }), buttons.push({ text: 'Pending' }), buttons.push({ text: 'Closed' }))
          $ionicActionSheet.show({
            buttons: buttons,
              ...
              switch (index) {
                ...
                case 2:
                  ...
                  return (
                    Tickets.update(reqTicket).then(
                      function (response) {
                        ;(t.status = 4), $scope.showSnackbar('Ticket status set to Working')
                      },
                      function (response) {
                        console.log(response)
                      }
